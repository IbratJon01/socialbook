    ...
    <>
     <List>
          {users.map((users, index) => (
            ...
            <ListItem key={index}  >
              <ListItemButton  sx={{ 
          display: { xs: "block", sm: "none"}}} component={Link} to='/messages' state={{dataUser:users , authUsers:authUsers.authUsers}}  >
              ...
              <ListItemButton  sx={{ 
          display: { xs: "none", sm: "block"}}} component={Link} to='/chat' state={{dataUser:users , authUsers:authUsers.authUsers}}  >
